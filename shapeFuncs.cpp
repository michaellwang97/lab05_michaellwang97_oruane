...
void initPoint(struct Point *p, double xVal, double yVal) {
  //precondition: xVal and yVal are the expected values
  //postcondition: the struct point now points to xVal and yVal
  p->x=xVal;
  p->y=yVal;
...
bool boxesApproxEqual(Box b1, Box b2, double tolerance) {
  ...
  return pointsApproxEqual(b1.ul, b2.ul, tolerance) && approxEqual(b1.width,b2.width,tolerance) && approxEqual(b1.height,b2.height,tolerance); // STUB!  TODO: Delete this line and comment and replace with appropriate code
}
